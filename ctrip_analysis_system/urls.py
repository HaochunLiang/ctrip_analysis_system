...
urlpatterns = [
    ...
    path('getquick/', SpiderCtrip.getQuick, name="getquick"),
    path('scrapydapi/', ScrapydCtrip.ScrapydAPI, name="scrapydapi"),
    path('scrapydapi1/', ScrapydCtrip.ScrapydAPI1, name="scrapydapi1"),
    path('getlasted/', ScrapydCtrip.getLasted, name="getlasted"),
